		...
		<div class="row">
			<div class="col-sm-3 well">
				<div class="well">
					...
					<img src="<c:url value="/assets/gthbLogo.png"/>" class="img-circle"
			...
			<div class="col-sm-7">
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="well">
							<p>John</p>
							<img src="<c:url value="/assets/gthbLogo.png"/>" class="img-circle" height="55" width="55"
								alt="Avatar">
						</div>
					</div>
					<div class="col-sm-9">
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="well">
							<p>Bo</p>
							<img src="<c:url value="/assets/gthbLogo.png"/>"class="img-circle" height="55"
								width="55" alt="Avatar">
						</div>
					</div>
					<div class="col-sm-9">
			...
			<div class="col-sm-2 well">
				<div class="thumbnail">
					<p>Upcoming Events:</p>
					<img src="<c:url value="/assets/gthbLogo.png"/>" alt="Paris" width="400" height="300">
					<p>
						<strong>Paris</strong>
					</p>
